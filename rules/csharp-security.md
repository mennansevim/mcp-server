...
**Bad:**
```csharp
System.Diagnostics.Process.Start("ping " + user_input);
```
...
- ✅ Always use `PasswordHasher` or `BCrypt`
...
- ✅ Use `RandomNumberGenerator` (C#) or `System.Security.Cryptography.RandomNumberGenerator`
